...
import 'package:news_app_anandu/components/themedata.dart';
import 'package:news_app_anandu/controller/controller.dart';
import 'package:news_app_anandu/screens/detailscreen.dart';
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: const InputDecoration(
                      border: OutlineInputBorder(), hintText: "SEARCH THE NEWS HERE...."),
                ),
              ),
              Padding(
                            ...
                            child: Stack(children: [
                              Image.network(
                                homeprovider.responsedata?.articles?[index]
                                        .urlToImage
                                        .toString() ??
                                    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxPMUGxWtrYtMyCqnL2hkfRi_rLTX2l6rPoA&usqp=CAU",
                                fit: BoxFit.fill,
                              ),
                              Positioned(
                                bottom: 25,
